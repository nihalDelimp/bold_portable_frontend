                            ...
                            <div className="process--content--wrapper">
                                <div className="bold--heading--wrapper">
                                    <div className="heading--big" data-aos="fade-up" data-aos-duration="1000">
                                        <h2>how to process??</h2>
                                    </div>
                                </div>
                                <p data-aos="fade-up" data-aos-duration="1000">Lorem ipsum dolor sit amet, conser psum dolor sit amet, Lorem ipsum dolor sit.
                                     Lorem ipsum dolor sit amet, conser psum dolor sit amet, Lorem ipsum dolor sit.
                                </p>
                            </div>
                            <a href="#" className="btn--process" data-aos="fade" data-aos-duration="1000">Rent It Now</a>
                        </div>
